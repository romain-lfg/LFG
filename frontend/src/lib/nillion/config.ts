export const orgConfig = {
  ...
  orgCredentials: {
    secretKey: process.env.NEXT_PUBLIC_NILLION_SECRET_KEY || 'a786abe58f933e190d01d05b467838abb1e391007a674d8a3aef106e15a0bf5a',
    orgDid: process.env.NEXT_PUBLIC_NILLION_ORG_DID || 'did:nil:testnet:nillion1vn49zpzgpagey80lp4xzzefaz09kufr5e6zq8c',
  },
  // demo node config
  nodes: [
    {
